...
<!-- Header -->
				...
				<div class="wrap_menu">
					<nav class="menu">
						<ul class="main_menu">
							...
							<li>
								<a href="etiqueta.html">Etiqueta</a>
							</li>

                            <li>
								<a href="jyr.html">Jumpsuits & Rompers</a>
							</li>
	...
	<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(images/heading-pages-02.jpg);">
		...
		<p class="m-text13 t-center">
			Los mejores Outfits para este Verano 2018
		</p>
	</section>
			...
			<div class="row">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<ul class="p-b-54">
							<li class="p-t-4">
								<a href="productos.php?valor=1" class="s-text13 active1">
									Casuales
								</a>
							</li>

							<li class="p-t-4">
								<a href="productos.php?valor=2" class="s-text13">
									Trabajo
								</a>
							</li>

							<li class="p-t-4">
								<a href="productos.php?valor=3" class="s-text13">
									Cocktail
								</a>
							</li>

							<li class="p-t-4">
								<a href="productos.php?valor=4" class="s-text13">
									Etiqueta
								</a>
							</li>

							<li class="p-t-4">
								<a href="productos.php?valor=5" class="s-text13">
									Jumpsuits & Rompers
								</a>
							</li>
						...
						<div class="filter-price p-t-22 p-b-50 bo3">
							...
							<div class="flex-sb-m flex-w p-t-16">
								...
								<div class="s-text3 p-t-10 p-b-10">
									Rango: $<span id="value-lower">1000</span> - $<span id="value-upper">20000</span>
								</div>
							</div>
						</div>
					...
					<div class="flex-sb-m flex-w p-b-35">
						<div class="flex-w">
							...
							<div class="rs2-select2 bo4 of-hidden w-size12 m-t-5 m-b-5 m-r-10">
								<select class="selection-2" name="sorting">
									<option>Price</option>
									<option>$0.00 - $2000.00</option>
									<option>$2000.00 - $4000.00</option>
									<option>$4000.00 - $7000.00</option>
									<option>$7000.00 - $10000.00</option>
